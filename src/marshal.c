...
void
play_marshal_VOID__UINT_OBJECT_POINTER (GClosure     *closure,
                                        ...
                                        gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__UINT_OBJECT_POINTER) (gpointer     data1,
                                                          guint        arg_1,
                                                          gpointer     arg_2,
                                                          gpointer     arg_3,
                                                          gpointer     data2);
  register GMarshalFunc_VOID__UINT_OBJECT_POINTER callback;
  ...
  callback = (GMarshalFunc_VOID__UINT_OBJECT_POINTER) (marshal_data ? marshal_data : cc->callback);
...
extern void play_marshal_VOID__UINT_STRING_POINTER (GClosure     *closure,
                                                    ...
                                                    gpointer      marshal_data);
void
play_marshal_VOID__UINT_STRING_POINTER (GClosure     *closure,
                                        GValue       *return_value G_GNUC_UNUSED,
                                        guint         n_param_values,
                                        const GValue *param_values,
                                        gpointer      invocation_hint G_GNUC_UNUSED,
...
extern void play_marshal_VOID__UINT_UINT64_UINT64_POINTER (GClosure     *closure,
                                                           ...
                                                           gpointer      marshal_data);
void
play_marshal_VOID__UINT_UINT64_UINT64_POINTER (GClosure     *closure,
                                               GValue       *return_value G_GNUC_UNUSED,
                                               guint         n_param_values,
                                               const GValue *param_values,
                                               gpointer      invocation_hint G_GNUC_UNUSED,
                                               gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__UINT_UINT64_UINT64_POINTER) (gpointer     data1,
                                                                 guint        arg_1,
                                                                 guint64      arg_2,
                                                                 guint64      arg_3,
                                                                 gpointer     arg_4,
                                                                 gpointer     data2);
  register GMarshalFunc_VOID__UINT_UINT64_UINT64_POINTER callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__UINT_UINT64_UINT64_POINTER) (marshal_data ? marshal_data : cc->callback);
...
extern void play_marshal_VOID__ENUM_STRING (GClosure     *closure,
                                            ...
                                            gpointer      marshal_data);
void
play_marshal_VOID__ENUM_STRING (GClosure     *closure,
                                GValue       *return_value G_GNUC_UNUSED,
                                guint         n_param_values,
                                const GValue *param_values,
                                gpointer      invocation_hint G_GNUC_UNUSED,
...
extern void play_marshal_VOID__STRING_STRING (GClosure     *closure,
                                              ...
                                              gpointer      marshal_data);
void
play_marshal_VOID__STRING_STRING (GClosure     *closure,
                                  GValue       *return_value G_GNUC_UNUSED,
                                  guint         n_param_values,
                                  const GValue *param_values,
                                  gpointer      invocation_hint G_GNUC_UNUSED,
